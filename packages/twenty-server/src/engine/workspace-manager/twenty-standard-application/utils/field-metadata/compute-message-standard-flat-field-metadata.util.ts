...
>): Record<AllStandardObjectFieldName<'message'>, FlatFieldMetadata> => ({
  ...
  deliveryStatus: createStandardFieldFlatMetadata({
    ...
    context: {
      ...
      description: i18nLabel(msg`Email delivery and engagement status`),
      icon: 'IconMailCheck',
      isNullable: true,
      isUIReadOnly: true,
      options: [
        {
          id: '4767c380-aa05-4c14-a057-5e66050466fd',
          value: 'SENT',
        ...
        {
          id: '0fab0c45-cee5-4e81-8f0a-3c4545e8ce9c',
          value: 'OPENED',
        ...
        {
          id: '23ac33ad-337a-418c-899b-c880aa1e3be6',
          value: 'CLICKED',
  ...
  scheduledAt: createStandardFieldFlatMetadata({
    ...
    context: {
      ...
      description: i18nLabel(msg`When the email was scheduled to be sent`),
  ...
  sentAt: createStandardFieldFlatMetadata({
    ...
    context: {
      ...
      description: i18nLabel(msg`When the email provider accepted the email`),
      icon: 'IconSend',
      isNullable: true,
      isUIReadOnly: true,
    },
  ...
  firstOpenedAt: createStandardFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      fieldName: 'firstOpenedAt',
      type: FieldMetadataType.DATE_TIME,
      label: i18nLabel(msg`First opened at`),
      description: i18nLabel(msg`When the tracking pixel was first loaded`),
      icon: 'IconEye',
      isNullable: true,
      isUIReadOnly: true,
    },
  ...
  lastClickedAt: createStandardFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      fieldName: 'lastClickedAt',
      type: FieldMetadataType.DATE_TIME,
      label: i18nLabel(msg`Last clicked at`),
      description: i18nLabel(msg`When a tracked email link was last clicked`),
      icon: 'IconClick',
      isNullable: true,
      isUIReadOnly: true,
    },
  ...
  openCount: createStandardFieldFlatMetadata({
    ...
    context: {
      ...
      description: i18nLabel(msg`Number of tracking pixel loads`),
      icon: 'IconEye',
      isNullable: false,
      isUIReadOnly: true,
      defaultValue: 0,
  ...
  clickCount: createStandardFieldFlatMetadata({
    ...
    context: {
      ...
      description: i18nLabel(msg`Number of tracked link clicks`),
      icon: 'IconClick',
      isNullable: false,
      isUIReadOnly: true,
      defaultValue: 0,
